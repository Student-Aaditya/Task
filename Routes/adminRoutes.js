...
router.delete("/api/manager/:id",auth,allowRoles("admin"),adminaController.deleteManager);


router.post("/api/vendors",auth,allowRoles("admin"),adminaController.createVendor);
router.get("/api/vendors",auth,allowRoles("admin"),adminaController.vendorList);
router.delete("/api/vendors/:id",auth,allowRoles("admin"),adminaController.deleteVendor);
